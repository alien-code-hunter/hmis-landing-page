...
const pool = new Pool({
  ...
  database: 'hmis_dashboard',         // Replace with your DB name
...
app.delete('/api/files/:id', isAuthenticated, async (req, res) => {
    ...
    app.get('/uploads/list', isAuthenticated, async (req, res) => {
        try {
            const result = await pool.query(
                'SELECT id, original_name, filename, mimetype, category, upload_date FROM uploaded_files ORDER BY upload_date DESC'
            );
